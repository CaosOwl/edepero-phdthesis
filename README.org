...
** TODO Comments of Pol for chapter 2 <2020-09-18 Fri> 
   - [ ] Is it necessary to quantify in section "Experimental Technique"?
   - [ ] in EOT sentence, I am not yet talking about background. Shifted background example here.
   - [ ] Source for 40 1E12 POT?
   - [ ] Hodoscope were present in the invisible mode 2018, remove from both text and drawings?
* TODO [72%]Diary
