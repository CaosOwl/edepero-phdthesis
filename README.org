...
** TODO Comments of Pol for chapter 1 <2020-09-17 Thu>
   - In page 5 refs is given in the beginning, needs to be repeated?
   - Proton charge radius to remove?
   - Rich sector to justify
   - page 7: while it is true that arrows goes in both ways, since I am talking about production is it not correct to keep the arrow this way?
   - Is A-resonant production corrections needed?
   - Removed last sentence of production chapter
* TODO [72%]Diary
