...
** DONE Comments of Pol for chapter 2 <2020-09-18 Fri> 
...
*** mail from Nikolaos about POT on target
    ...
    Cheers, Nikos 
** DONE Comments of Laura chapter 3 pt.1 <2020-09-21 Mon>   
* TODO [100%]Diary
...
*** DONE Check background
    - [X] estimate of mu-->enunu decay, currentyl I estimated 1e-5 for decay prob and 1e-7 for beam composition and SRD, more?
    - [X] Estimate for momentum reconstruction, 1e-12 cited in Dipa thesis is not too clear, and also not sufficient at out current levels.
** <2020-08-14 Fri>
...
** DONE [12/12] Substitution to a common standard
   Python skript?
   - [X] Tab. --> Table
   - [X] chapter
   - [X] Fig.
   - [X] S_i , for scintillators in the setup
     - Si
   - [X] Dark Matter
   - [X] Dark Photon
   - [X] punch-through
   ...
   - [X] well-defined
     - well defined
** DONE Standard for tables
   - currently <2020-08-18 Tue> no vertical line, double line if table shows a result, to generalize
   - Sopme diversity was mantained after all <2020-10-07 Wed>
** DONE Check picture resolution
   - check that every picture has the correct resolution
*** DONE [2/2] list of picture to change:
    - [X] 1.1, improve resolution
    - [X] 1.3, improve resolution
** DONE References
   - [X] Fix reference order
* DONE [#A] [1/1]Issue to solve
  - [X] Currently the abstract command fails for unknow reason. But the text is visualized as intended.
