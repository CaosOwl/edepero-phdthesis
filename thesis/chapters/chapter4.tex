...
Where not only the parameter relevant in our experiment are present but also the ones relevant for cosmological models. In particular, $y$ scales directly with the direct annihilation cross section of DM in the thermal bath. %This means that the space $\dmyplane$ contains the region 
