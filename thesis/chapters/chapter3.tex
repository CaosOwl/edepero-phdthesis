...
Then, we will provide a description of both the analysis performed for the invisible and visible mode setup in Sec.\ref{ch3:sec:analysis-invis} and Sec.\ref{ch3:sec:analysis-vis} respectively. In the case of the visible mode, this section also includes a new analysis which uses the information recorded by the trackers on top of the one provided by the calorimeters.
...
In this section, we can give a brief overview of the two main methods used to reject hadrons (and muons) contamination in the beam developed as a consequence of my work.
...
\subsubsection{Visible mode analysis using the calorimeter approach}
\label{ch3:sec:vis-mode-calorimeter}
