...
The efficiency of these cuts were studied using the MC simulation and the control sample to correct for intensity effect. A small summary of the uncertainty is provided in Tab.\ref{tab:inv-cut-eff} . 
