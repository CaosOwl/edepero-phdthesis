...
\thesistitle{Search for a new Light Dark Boson using Fixed Target in the NA64 experiment.} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
