...
\examiner{Prof. G{\"u}nther Dissertori and Dr. Sergei Gninenko} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
\degree{Doctor of Sciences of ETH Zurich} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\vspace*{.06\textheight}
{\scshape\LARGE DISS. ETH. NO. 27194}\vspace{1.5cm} % University name
\\[0.5cm] % Thesis type
...
\large \textit{A thesis submitted to attain the degree of \\ \textbf{\degreename}}\\[0.3cm] % University requirement text
\textit{(Dr. sc. ETH Zurich)}\\[0.4cm]

\vfill

\large \textit{presented by}\\[0.3cm]
\href{}{\authorname}\\[0.2cm] % Author name - remove the \href bracket to remove the link
...
\large \textit{Accepted on the reccomendation of}\\[0.3cm] % University requirement text
Prof. Paolo Crivelli, examiner\\[0.1cm]
Prof. Sergei Gninenko, co-examiner\\[0.1cm]
Prof. G{\"u}nther Dissertori, co-examiner\\[0.1cm]
...
%----------------------------------------------------------------------------------------
%	ABSTRACT PAGE IN ITALIANO
% ----------------------------------------------------------------------------------------

\begin{abstract}
  \addchaptertocentry{\abstractname} % Add the abstract to the table of contents  
  \input{chapters/abstract_ita.tex}
\end{abstract}
