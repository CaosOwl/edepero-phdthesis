...
\thesistitle{Search for Light Dark Matter and Dark Mediators using a Fixed Target in the NA64 experiment} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
