...
\begin{table}[h]
  \centering
  \caption{\label{table:table1}Estimated total punch-through probability after four HCAL modules ($\sim7\lambda_{\text{int}}$) for hadrons induced shower particles.}
  \begin{tabular}{c|cccc}
    $P_{\text{pt}}$  & 10 GeV & 30 GeV & 50 GeV & 100 GeV \\  
    \hline
    $p$ & - & $(7\pm3)\cdot10^{-5}$  & $(1.2\pm0.3)\cdot10^{-4}$  & $(5.4\pm0.7)\cdot10^{-4}$ \\
    $n$ & - & $(6\pm2)\cdot10^{-5}$  & $(2.2\pm0.5)\cdot10^{-4}$  & $(5.9\pm0.8)\cdot10^{-4}$ \\
    $K^{-}$ & $(6.0\pm0.8)\cdot10^{-4}$  & $(7.1\pm0.8)\cdot10^{-4}$  &  $(7.9\pm0.9)\cdot10^{-4}$ & $(1.0\pm0.1)\cdot10^{-3}$ \\
    $\pi^{-}$ &  $(2.2\pm0.5)\cdot10^{-4}$ & $(2.4\pm0.5)\cdot10^{-4}$  &  $(4.2\pm0.6)\cdot10^{-4}$ & $(7.5\pm0.9)\cdot10^{-4}$\\
    \hline
  \end{tabular}
  \label{tab:hadron-punch-prob}
\end{table}
