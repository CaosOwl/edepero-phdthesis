...
\label{AppendixA:sec:thermal-dark-matter}

\section{Cross section}
\label{AppendixA:sec:cross-section}

\subsection{The Weizsacker-Williams approximation}
\label{AppendixA:sec:cross-section-wz}

\subsection{The Tree-level corrections}
\label{AppendixA:sec:cross-section-tl}

\section{Decay length}
\label{AppendixA:sec:decay-length}
