...
\chapter{Algorithms and particle tracking} % Main appendix title
...
\begin{figure}[bth!]
  \centering
  \includegraphics[width=0.45\textwidth]{\appdird/raw-ecal33.pdf}
  \includegraphics[width=0.45\textwidth]{\appdird/wave-ecal33.pdf}
  \includegraphics[width=0.45\textwidth]{\appdird/raw-pil-ecal33.pdf}
  \includegraphics[width=0.45\textwidth]{\appdird/wave-pil-ecal33.pdf}    
